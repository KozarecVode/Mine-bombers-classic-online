...
const WEAPONS = ['tnt', 'bigcross', 'smallcross', 'grenade', 'smallbomb', 'bigbomb', 'landmine', 'flamebomb', 'flamethrower', 'fireextinguisher', 'smalldetonate', 'bigdetonate', 'urethane', 'plastic', 'nuclear', 'jumpingbomb'] as const;
...
function loop(ts: number): void {
  ...
  updatePlayer(player, input.getDirection(), input.consumeStopPress(), terrain, [tntMgr, bigCrossMgr, smallCrossMgr, smallBombMgr, bigBombMgr, flameBombMgr, smallDetMgr, bigDetMgr, urethaneMgr, plasticMgr]);
  ...
  if (input.consumeTntPress()) {
    ...
    else if (selectedWeapon === 'urethane')      urethaneMgr.place(player.x, player.y, terrain);
    else if (selectedWeapon === 'plastic')       plasticMgr.place(player.x, player.y, terrain);
  ...
  renderer.render(assets, terrain, [player], player, tntMgr, bigCrossMgr, smallCrossMgr, grenadeMgr, smallBombMgr, bigBombMgr, landmineMgr, flameBombMgr, flamethrowerMgr, fireExtMgr, smallDetMgr, bigDetMgr, urethaneMgr, plasticMgr, nuclearMgr, jumpingBombMgr, selectedWeapon);
}
